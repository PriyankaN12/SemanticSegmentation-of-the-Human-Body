...
def visualize(batch_data, pred, args):
    colors = loadmat('data/color150.mat')['colormap']
    (imgs, segs, infos) = batch_data
...
if __name__ == '__main__':
    ...
    parser.add_argument('--list_train',
                        default='./data/hdata/train_id.txt')
    parser.add_argument('--list_val',
                        default='./data/hdata/val_id.txt')
    parser.add_argument('--root_img',
                        default='./data/hdata/images')
    parser.add_argument('--root_seg',
                        default='./data/hdata/annotations')
